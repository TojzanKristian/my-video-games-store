...
const NavBarAddNewGame: React.FC = () => {
    return (
        <div style={navBarStyle}>
            <ul className="nav nav-pills nav-fill">
                ...
                <li className="nav-item">
                    <Link to="/add-new-game" className="nav-link" style={activeLinkStyle}>Dodavanje nove igrice</Link>
                </li>
            </ul>
        </div>
    );
...
export default NavBarAddNewGame;